...
<section id="hero1">
  ...
  <div class="imag-item active" style="background-image: url(assets/img/ريحان3.jpg)">
      <div class="imag-container">
          <div class="container">
              <h2 class="animate__animated animate__fadeInDown"><span> مقابر مدينه 15 مايو</span></h2>
          </div>
      </div>
  </div>
</section><br>
    ...
    <div class="row content">
        <div class="">
            <div class=" text-center">
                <h2 class="animate__animated animate__heartBeat">مقابر ومدافن للبيع بمدينه 15 مايو</h2>
                <p>
                  إذا كانت لديك الرغبة في الحصول على مقابر مشطبة بالكامل، ذات تأمين في مدينه 15 مايو
                   ، فإن روح و ريحان للمقابر تقدم لكم مقابر ومدافن في مدينه 15 مايو بالإضافة إلى أن كل المقابر مسجلة ومرخصة في الشهر العقاري.
                </p>
            </div>
            <hr>
        ...
        <div class="desc col-lg-12">
          ...
          <h4>لماذا تعتبر شركة روح و ريحان للمقابر أفضل خيار لمقابر للبيع بمدينه 15 مايو؟
          </h4>
          <p class="fst-italic">
            <ul>
      ...
      <div class="desc col-lg-12">
      <h4>مقابر ومدافن مدينه 15 مايو ومميزات شركة روح و ريحان للمقابر</h4>
        <p class="fst-italic">
          <ul>
